...
@Test
public void sheet() throws IOException,Exception
{
	driver.get("https://www.facebook.com");
	FileInputStream fi=new FileInputStream("C:\\Users\\dell\\Desktop\\Book1.xlsx");
	...
	for(int i=1;i<=rowcount;i++)
	{
		...
		driver.findElement(By.name("login")).sendKeys(pswd);
